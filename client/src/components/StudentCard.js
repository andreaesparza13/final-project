...
function StudentCard({ first_name, last_name, grade_level, preferred_name, pronouns, private_pronouns, extra_info, id }) {
   ...
   return (
      <div className="p-6 w-96 bg-slate-300 rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 m-6 ml-auto mr-auto">
         ...
         <p className="font-medium text-black mb-3 dark:text-gray-400" >
            {pronouns} <b>{private_pronouns ? "KEEP PRIVATE" : null}</b>
         </p>
